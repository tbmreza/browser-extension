...
{#each ["left-top", "left-bottom", "right-top", "right-bottom"] as placement}
  <!-- This isn't the `a` element's intended use (not a hyperlink to go to another page). -->
  <!-- svelte-ignore a11y-missing-content -->
  <!-- svelte-ignore a11y-missing-attribute -->
  <a class="github-fork-ribbon {placement}" data-ribbon={text.toUpperCase()} title="Click to hide."></a>
{/each}

<!-- TODO click to hide one. -->
<!-- TODO interact with Popup.svelte -->
